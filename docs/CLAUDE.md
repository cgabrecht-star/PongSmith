...
1. `docs/FOUNDATION.md` — Strategie, Persona, USP, Konkurrenz, Tech-Stack, Roadmap
2. `docs/ROADMAP.md` — Aktueller Phasen-Status und nächste Aufgaben
3. `docs/SETUP_INVENTUR.md` — Nur lesen, wenn der Task mit Erfahrungs-DB oder Spielerdaten zu tun hat

---

## Tech-Stack (final, nicht verhandeln)

- **Frontend:** Next.js 15 (App Router) + TypeScript (strict)
- **Styling:** Tailwind CSS + shadcn/ui
- **Datenbank:** PostgreSQL via Supabase (Region Frankfurt eu-central-1)
- **ORM:** Drizzle ORM
- **KI-API:** Anthropic Claude API (`@anthropic-ai/sdk`), Modell `claude-opus-4-7` für Berater-Dialog, `claude-haiku-4-5` für günstige Hintergrund-Tasks
- **Hosting:** Vercel
...
- Branch-Strategie: erstmal alles auf `main`. Bei Phase 4 ggf. Feature-Branches einführen.
...
- **Belagtypen:** Noppen innen (Standard, "Glatt"), Noppen außen (kurz/mittel/lang), Anti-Topspin.
...
- Wenn der Anthropic-API-Key in einem Request mit über 10.000 Tokens verbraucht würde, vorher Hinweis geben (Kosten-Awareness).
...
*Letzte Änderung: 02.05.2026 — Initial-Erstellung Phase 0*
